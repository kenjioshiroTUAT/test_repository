...
CONFIG.USE_DYN_RECONFIG {true} \
  ...
  # Create instance: ip_disabling_byte_addressing_0, and set properties
  set ip_disabling_byte_addressing_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ip_disabling_byte_addressing:1.0 ip_disabling_byte_addressing_0 ]
...
CONFIG.PCW_USE_M_AXI_GP1 {0} \
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M01_AXI [get_bd_intf_pins axi_mem_intercon/M01_AXI] [get_bd_intf_pins clk_wiz_0/s_axi_lite]
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_pins axi_bram_ctrl_0/bram_addr_a] [get_bd_pins ip_disabling_byte_addressing_0/axi_bram_ctrl_addr]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins axi_bram_ctrl_0/bram_rddata_a] [get_bd_pins blk_mem_gen_0/douta]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M02_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net ip_disabling_byte_addressing_0_my_bram_addr [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins ip_disabling_byte_addressing_0/my_bram_addr]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins clk_wiz_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins clk_wiz_0/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0]
...
#  -string -flagsOSRD
preplace port DDR_0 -pg 1 -y 500 -defaultsOSRD
preplace port FIXED_IO_0 -pg 1 -y 520 -defaultsOSRD
...
preplace inst ip_disabling_byte_addressing_0 -pg 1 -lvl 4 -y 40 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 3 -y 290 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 2 -y 260 -defaultsOSRD
...
preplace netloc axi_bram_ctrl_0_bram_addr_a 1 3 1 NJ
preplace netloc axi_bram_ctrl_0_bram_clk_a 1 3 2 NJ 90 1360
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 460
preplace netloc ip_disabling_byte_addressing_0_my_bram_addr 1 4 1 1360
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 260 400
preplace netloc axi_mem_intercon_M00_AXI 1 2 1 770
preplace netloc axi_mem_intercon_M02_AXI 1 2 1 750
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 420 90 760
preplace netloc axi_gpio_0_gpio_io_o 1 0 4 40 450 NJ 450 NJ 490 1060
preplace netloc processing_system7_0_FIXED_IO 1 1 5 NJ 520 NJ 520 NJ 520 NJ 520 NJ
preplace netloc axi_bram_ctrl_0_bram_wrdata_a 1 3 2 NJ 100 N
preplace netloc clk_wiz_0_clk_out1 1 0 4 20 70 440 70 790 210 1060
preplace netloc axi_bram_ctrl_0_bram_we_a 1 3 2 NJ 160 N
preplace netloc blk_mem_gen_0_douta 1 3 2 NJ 120 N
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 2 410 50 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 1 430
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 40 250 450 100 780
preplace netloc axi_bram_ctrl_0_bram_en_a 1 3 2 NJ 140 N
levelinfo -pg 1 0 220 610 930 1210 1450 1560 -top 0 -bot 710
",
}
