...
HD_PWD='C:/Vivado_projects/Geyser_mem_ver1.1/Geyser_mem_ver1.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BusController16.vds -m64 -mode batch -messageDb vivado.pb -notrace -source BusController16.tcl
