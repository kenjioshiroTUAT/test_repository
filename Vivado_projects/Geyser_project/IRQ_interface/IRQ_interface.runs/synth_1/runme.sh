...
HD_PWD='C:/Vivado_projects/IRQ_interface/IRQ_interface.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bram_Interface.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Bram_Interface.tcl
