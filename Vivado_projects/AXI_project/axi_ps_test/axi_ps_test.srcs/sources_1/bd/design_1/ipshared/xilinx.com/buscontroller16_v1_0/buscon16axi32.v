...
module BUS16AXI32CONTROL(
  ...
  wire [31:0] TransAddress =
         ((BC16Address[31:20] == 12'hbfc) || (BC16Address[31:20] == 12'ha00)) ?
  ...
  //(BC16Address[31:16] == 16'hbfc0)
  //(BC16Address[31:20] == 12'h800)
  //(32'hbfc0_0000 <= BC16Address && BC16Address < 32'hbfc2_0000)
  //12'h300, BC16Address[19:2], 2'b00 20180105
  reg [31:0] RegAddress ;
  reg [3:0]  RegByteEn32;
  ...
  wire [3:0] AxLen = RegBurst ? 4'd15 : 4'd0; // 2018-01-05
