...
`define DECODE_BOOTROM  (32'h0000_0000 <= Address && Address < 32'h0000_0000 + 32'h0010_0000) 
`define DECODE_BOOTROMC (Address[31:16]== 16'h9fc0)
//`define DECODE_AXI      (Address[31:20]== 12'ha00)
//`define DECODE_AXI      (32'hbfc0_0000 <= Address && Address < 32'hbfc2_0000) 
`define DECODE_AXI      (Address[31:20] == 12'ha00)
`define DECODE_AXIC     (Address[31:20]== 12'hbfc)
//`define DECODE_AXIC     (Address[31:16]== 16'h0000)
...
`define AM_31     2'b11
   ...
   assign ModuleCapBlock[`BUS_DEVICE]      = `NUM_DEVICE'b01011;
   assign ModuleCapWritables[`BUS_DEVICE]  = `NUM_DEVICE'b11101;
   assign ModuleCapReadDelays[`BUS_DEVICE] = `NUM_DEVICE'b00010;
